...
app.get('/api/posts/getAvg?', postsCtrl.findAvg); // Autocomplete tag entry from posts. Accepts query parameter that is specially formatted for autocomplete. Posts collection.
